...
import 'create_care_plan_modal.dart';
...
class _CarePlansScreenState extends State<CarePlansScreen>
                          ...
                          return Container(
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                const SizedBox(height: 16),
                                // 4 Column Boxes (2x2 Grid)
                                if (entry.hasColumnContent) ...[
                                  // First Row: Nursing Diagnosis & Goals
                                  Row(
                                    crossAxisAlignment: CrossAxisAlignment.start,
                                    children: [
                                      Expanded(
                                        child: _buildEntryColumnBox(
                                          'Nursing Diagnosis',
                                  ...
                                  const SizedBox(height: 12),
                                  // Second Row: Nursing Orders & Rationales
                                  Row(
                                    crossAxisAlignment: CrossAxisAlignment.start,
                                    children: [
                                      Expanded(
                                ...
                                ] else if (entry.notes != null && entry.notes!.isNotEmpty) ...[
                                  // Fallback to notes content if no column data
                                  _buildEntryCell(
  ...
  Widget _buildEntryColumnBox(String title, String? content, IconData icon, Color color) {
    return Container(
      padding: const EdgeInsets.all(12),
      decoration: BoxDecoration(
