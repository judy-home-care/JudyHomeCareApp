...
class PatientNotificationPreferencesScreen extends StatefulWidget {
  final Map<String, dynamic> userData;
  
  const PatientNotificationPreferencesScreen({
    Key? key,
    required this.userData,
  }) : super(key: key);

  @override
  State<PatientNotificationPreferencesScreen> createState() => _PatientNotificationPreferencesScreenState();
}

class _PatientNotificationPreferencesScreenState extends State<PatientNotificationPreferencesScreen> {
      ...
      if (result['success'] && result['data'] != null) {
        ...
        if (prefs != null) {
          setState(() {
            ...
            _appointmentReminders = prefs['appointment_reminders'] ?? true;
            ...
            _emergencyAlerts = prefs['emergency_alerts'] ?? true;
  ...
  Widget _buildHealthCareNotifications() {
    return _buildSection(
      title: 'Health & Care',
      ...
      child: Column(
        children: [
          _buildNotificationToggle(
            ...
            subtitle: 'Upcoming appointments and visits',
          ...
          //   subtitle: 'Reminders to log your vital signs',
          //   value: _vitalsTracking,
          //   onChanged: (value) => setState(() => _vitalsTracking = value),
          //   enabled: _allNotifications,
          // ),
          const SizedBox(height: 12),
          _buildNotificationToggle(
            icon: Icons.note_alt_outlined,
            title: 'Progress Note Reminders',
            subtitle: 'Updates when care or therapy notes are added',
            value: _progressNoteReminders,
      ...
      child: Column(
        children: [
          _buildNotificationToggle(
            ...
            subtitle: 'Critical health and safety alerts',
