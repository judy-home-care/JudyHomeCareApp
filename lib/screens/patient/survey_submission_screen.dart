...
class SurveySubmissionScreen extends StatefulWidget {
  final int surveyId;
  final String surveyTitle;

  const SurveySubmissionScreen({
    Key? key,
  ...
  @override
  State<SurveySubmissionScreen> createState() => _SurveySubmissionScreenState();
}

class _SurveySubmissionScreenState extends State<SurveySubmissionScreen> {
  ...
  Future<void> _loadSurveyDetails() async {
    ...
    final response = await _surveyService.getSurveyDetails(widget.surveyId);
